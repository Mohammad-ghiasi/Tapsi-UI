    ...
    return (
        ...
        <ThemeProvider theme={theme}>
            <Box className="bg-city bg-center bg-no-repeat bg-cover py-2 mt-6 mb-6 lg:mb-32 lg:mt-32  px-16">
                <Box className="transition grid grid-cols-1 h-auto lg:h-[160px]  md:grid-cols-4 place-items-center place-content-center text-gray-200">
                    ...
                    <Box className="hover-target w-[100%] py-3">
