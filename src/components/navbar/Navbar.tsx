...
import { AppBar, Toolbar, IconButton, Typography, Drawer, List, ListItem, ListItemText, Box, Container, Button, Divider } from '@mui/material';
...
const font = "../../../public/asset/fonts/Rezvan/Rezvan.ttf";
